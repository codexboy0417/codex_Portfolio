...
import profilePicture from "../../assets/profilePicture.jpg?url";

const PROFILE_IMAGE = profilePicture;
const CONTACT_EMAIL = "sanjuupadhyay262@gmail.com";
...
export function Hero() {
  ...
  const workItems = [{ label: "Projects", href: "/projects", section: "projects" }];
        ...
        <div ref={layerText} style={{ willChange: "transform" }}>
          ...
          <div style={{ overflow: "hidden", marginBottom: "2rem" }}>
            ...
            >
              ...
              >
                3rd-year AI &amp; ML student turning coursework into real,
                working projects.
              </span>
            </m.div>
          </div>
